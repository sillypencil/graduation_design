...
$(function(){
	$("#project_createicon").click(function(){
		if($("#project_create_border").css("display") == "none"){
			...
			$(this).css("background","url(../public/images/4.12/添加项目按钮2.png) center no-repeat");
			$(this).css("background-size","contain");
		}else{
			$("#project_create_border").css("display","none");
			$(this).css("background","url(../public/images/4.12/添加项目按钮1.png) center no-repeat");
			$(this).css("background-size","contain");
		}
	});
});
...
$(function(){
	$(document).on("mouseover",".photo",function(){
		$(this).css("background","url(../public/images/4-10/组员头像.png) center no-repeat");
		$(".currentuser").css("background-size","contain");
	});
	$(document).on("mouseleave",".photo",function(){
		$(this).css("background","url(../public/images/4-10/组员头像Z.png) center no-repeat");
		$(".currentuser").css("background-size","contain");
	});
});
// 新建项目
